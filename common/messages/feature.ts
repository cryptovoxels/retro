...
export const RideRecord = t.intersection(
  [
    VoxCommonRecord,
    t.type({
      type: t.literal('ride'),
...
export type RideRecord = t.TypeOf<typeof RideRecord>
