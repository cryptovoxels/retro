...
module.exports = (env, argv) => {
  return merge(webpackCommon(env, argv), {
    ...
    plugins: [new webpack.IgnorePlugin({ resourceRegExp: /^\.\.\/\.\.\/src$/ }), new webpack.IgnorePlugin({ resourceRegExp: /src\/voxels-map$/ }), new webpack.IgnorePlugin({ resourceRegExp: /src\/ui\/explorer$/ })],
    module: {
      rules: [
        {
          test: /\.([cm]?ts|tsx)$/,
