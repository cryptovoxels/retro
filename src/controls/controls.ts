...
export default abstract class Controls implements IControls {
  ...
  private updateVehicle() {
    ...
    if (abs) {
      ...
      // first person stays aimed with the car; third person keeps mouse look so you can orbit like walking
      if (this.firstPersonView) this.camera.rotation.y = this.driveFacingYaw(car)
    }
